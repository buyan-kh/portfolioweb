...
export function Contact() {
  ...
  const contactInfo = {
    ...
    socials: [
      {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/buyankh/',
      },
      {
        name: 'Youtube',
        url: 'https://www.youtube.com/@BuyanKh',
      },
      {
        name: 'Instagram',
        url: 'https://www.instagram.com/buyan__kh/',
      },
      {
        name: 'Github',
        url: 'https://github.com/buyan-kh',
      },
      {
        name: 'X',
        url: 'https://x.com/buyan_kh',
      },
    ],
  };
